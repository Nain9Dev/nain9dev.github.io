...
ogImage: "/assets/images/clean-architecture-3d-og.png"
...
<div class="blog-cta" id="lead-magnet">
  ...
  <p style="margin-top: 1.5rem; font-size: 0.9em; color: var(--text-color-light);">
    ¿Tu sistema ya está en producción y sufres cuellos de botella? <a href="https://calendly.com/aitornainmendozavallejo-ksez/30min" target="_blank" rel="noopener noreferrer" style="font-weight: 600;">Reserva una auditoría de 15 minutos conmigo.</a>
  </p>
