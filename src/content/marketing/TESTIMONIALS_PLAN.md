...
## Plantilla de Solicitud (Email/LinkedIn)
> "Hola [Nombre], estoy lanzando mi nuevo portafolio de Arquitectura Backend y me encantaría incluir una reseña tuya sobre nuestro trabajo conjunto en [Proyecto]. ¿Podrías compartir en 2 o 3 líneas cómo te ayudó mi enfoque técnico o cómo mejoró el rendimiento del sistema? No tiene que ser nada formal. ¡Mil gracias!"
...
Una vez obtenidos, se rellenará el archivo `src/data/testimonials.json` y se habilitará el componente en `index.astro`.
